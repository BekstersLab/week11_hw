...
def home_page():  # define function called when root or /home url is accessed
    ...
    # nav_urls=nav_urls - first nav_urls is name of variable as it will be accessible in the template. The second nav_urls is the Python variable holding the dictionary returned by 'get_navigation_urls'
...
# in layout.html for example {{ nav_urls.home_url }}, the values of the dictionary generated by the 'get_navigation_urls()' function are accessed and passed to the template with the name 'nav_urls'
